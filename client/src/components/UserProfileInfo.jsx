        ...
        <div  className='flex flex-col md:flex-row items-center gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className='flex flex-col md:flex-row items-start justify-between'>
                   ...
                   {!profileId && 
                   <button onClick={()=> setShowEdit(true)} className='cursor-pointer flex items-center gap-2 border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0'>
